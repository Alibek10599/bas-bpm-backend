...
import { RmqCodeExecutionController } from './rmq.code-execution.controller';
...
describe('RmqCodeExecutionController', () => {
  let controller: RmqCodeExecutionController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      controllers: [RmqCodeExecutionController],
      providers: [
        {
    ...
    controller = module.get<RmqCodeExecutionController>(
